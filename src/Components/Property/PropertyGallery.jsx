...
const PropertyGallery = ({ imgList }) => {
  const [isGalleryModalOn, setGalleryModalOn] = useState(false);

  const handleGalleryModal = useCallback(() => {
    setGalleryModalOn(!isGalleryModalOn);
  }, [isGalleryModalOn]);

  const closeGalleryModal = () => {
    setGalleryModalOn(false);
  };
  ...
  return (
    <>
      ...
      {isGalleryModalOn && (
        <GalleryModal imgList={imgList} closeGalleryModal={closeGalleryModal} />
      )}
    </>
  );
};
